...
export const metadata = {
  ...
  applicationName:siteConfig.name,authors:[{name:siteConfig.name}],creator:siteConfig.name,publisher:siteConfig.name,category:"Entertainment",icons:{icon:"/favicon.svg"},verification:{google:process.env.GOOGLE_SITE_VERIFICATION||undefined},
